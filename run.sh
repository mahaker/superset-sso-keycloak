...
docker run --name my_keycloak -p 8080:8080 -p 9000:9000 --env-file ../env.list --add-host=host.docker.internal:host-gateway -d my_keycloak start-dev  --spi-theme-static-max-age=-1 --spi-theme-cache-themes=false --spi-theme-cache-templates=false
